...
def scrape_and_store_jobs(search: my_types.JobSearchEntry, is_new_search=False) -> None:
        ...
        for search_term in search_terms:
            try:
                jobs = scrape_jobs(
                    ...
                    linkedin_fetch_description=job_source == "linkedin",  # Specific to LinkedIn, unneeded for others.
                )
